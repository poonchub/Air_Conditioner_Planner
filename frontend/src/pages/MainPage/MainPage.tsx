            ...
            >
                ...
                <DialogContent>
                    <DialogContentText sx={{ color: '#000' }}>
                        เวลาที่ใช้งานมีผลต่อการคำนวณขนาด BTU หากต้องการขนาด BTU ที่ใช้ได้ในทุกช่วงเวลา แนะนำระบุให้อยู่ในช่วงเวลา 8:00-18.00น. ตามจำนวนเวลาที่ใช้งาน
                    </DialogContentText>
                </DialogContent>
                <DialogActions>
                                        ...
                                        <GridItem>
                                            ...
                                            <Box>
                                                <Text color={"gray"} fontSize={14} marginTop={2}>
                                                    ค่าไฟข้างต้นเป็นการประมาณการจากการคำนวณตามอัตราไฟฟ้าแบบขั้นบันได พร้อม Ft และ VAT 7% โดยอิงจากขนาด BTU ของเครื่องปรับอากาศแและใช้ค่า SEER = 18 เท่านั้น  ค่าไฟจริงอาจสูงหรือต่ำกว่านี้ ขึ้นอยู่กับประสิทธิภาพของเครื่องปรับอากาศ ปริมาณการใช้ไฟฟ้าและพฤติกรรมการใช้งานของผู้ใช้
                                                </Text>
                                            </Box>
