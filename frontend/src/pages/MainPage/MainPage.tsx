                                                            ...
                                                            <Table.Cell>
                                                                <FormControl fullWidth>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <MenuItem value={"ConcreteTile"}>
                                                                            หลังคากระเบื้องคอนกรีต
                                                                        </MenuItem>
                                                                        <MenuItem value={"MetalSheet"}>
                                                                            หลังคาเมทัลชีท
                                                                        </MenuItem>
                                                                    </Select>
                                                                </FormControl>
                                                                ...
                                                                <FormControl fullWidth>
                                                                    <Select
                                                                        ...
                                                                        onChange={(e) =>
                                                                            setFormData((prev) => ({
                                                                                ...prev,
                                                                                kRoofColor: Number(e.target.value),
                                                                            }))
                                                                        }
                                                                    >
                                                                ...
                                                                <Table.Cell>
                                                                    <FormControl fullWidth>
                                                                        <Select
                                                                            displayEmpty
                                                                            sx={{ width: "100%" }}
                                                                            value={formData.floorValue.uFloor}
                                                                            onChange={(e) => {
                                                                            ...
                                                                            onChange={(e) => {
                                                                                ...
                                                                                setFormData((prev) => {
                                                                                    ...
                                                                                    updated[index] = {
                                                                                        ...
                                                                                        quantity: newValue,
                                                                                        qEquipment:
                                                                                            updated[index].powerW *
                                                                                            updated[index].clf *
                                                                                            newValue,
                                                                                    };
                                                                                    return {
                                                                                        ...prev,
                                                                                        equipmentValue: updated,
                                                                                    };
                                                                                });
                                                                            }}
                                                                        />
